...
export default function CustomFitClient({ product }) {
    ...
    const handleSubmit = () => {
        toast.success("Your custom size request has been submitted! Our team will contact you soon.");
        router.push("/orders");
    };
        ...
        switch (currentStep) {
                ...
                return (
                    <div className="space-y-6">
                        <p className="text-muted-foreground mb-6">
                            Provide your measurements in inches. Don&apos;t worry if you&apos;re unsure – our team will contact you to
                            confirm.
                        </p>
            ...
            case 2:
                return (
                    <div className="space-y-6">
                        <p className="text-muted-foreground mb-6">
                            Customize how your printed T-shirt or jersey should fit and feel.
                        </p>
                        <div>
                        ...
                        <div>
                            ...
                            <Select
                                value={preferences.collarStyle}
                                onValueChange={(value) => handlePreferenceChange("collarStyle", value)}
                            >
                ...
                return (
                    <div className="space-y-6">
                        <div className="border rounded-lg p-6 space-y-4">
                            <h2 className="font-semibold text-lg mb-4">Your Measurements</h2>
                        ...
                        <div className="border rounded-lg p-6 bg-primary/5">
                            ...
                            <ol className="space-y-2 list-decimal list-inside text-muted-foreground">
                                ...
                                <li>Your customised tee, jersey or kit will be prepared in Chennai</li>
